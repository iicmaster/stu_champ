		...
		<table width="100%">
			...
			<tbody>
				...
				$sql = 'SELECT	
							...
							material_order_item.quantity_receive as quantity, 
				...
				{
					$quantity_receive = ($data['quantity'] != '') ? add_comma($data['quantity']) : '<span class="block center red">ยังไม่ได้ตรวจรับ</span>';
					echo '<tr>
